...
; ===========================================================================
; Crash/Freeze the 68000. Like sonic 2, the sound driver is now Z80 based, thus the music continues playing.
...
; ---------------------------------------------------------------------------
; Horizontal interrupt f_doupdatesinhblank
; ---------------------------------------------------------------------------
...
; End of function ClearScreen
		...
		include	"Sound/sub PlaySound.asm"
...
ObjPos_Null:	dc.b $FF, $FF, 0, 0, 0,	0
	...
	include "sound/sub SounddriverLoad.asm"
...
; ---------------------------------------------------------------------------
SonicDriverVer = 2 ; Tell SMPS2ASM that we're using Sonic 1's driver.
