...
s1TempotoS2Z80 function n,((((conv0To256(n)-1)<<8)+(conv0To256(n)>>1))/conv0To256(n))&0FFh
...
smpsClearPush macro
	...
	elseif SonicDriverVer==2
		...
		fatal "Coord. Flag to clear S1 push block flag does not exist in S3 driver. Complain to Flamewing to add it."
	endif
	endm
